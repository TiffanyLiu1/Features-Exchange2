...
if __name__ == '__main__':
    ...
    # # only train with the first 1000 images in 1 batch, so local_bs = 1000
    # dict_users = {0: np.array(range(1000), dtype='int64')}
    # train_loader = DataLoader(DatasetSplit(dataset_train, dict_users[0]), batch_size=args.local_bs, shuffle=True)
    # ................ check if fed same as nn ...................
    ...
    plt.savefig('C:/Users/Pinky/PycharmProjects/FedAvg/Plots/nn_{}_{}_{}.png'.format(args.dataset, args.model, args.epochs))
