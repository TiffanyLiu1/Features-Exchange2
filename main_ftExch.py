...
from Nets import MLP, MLP_First, MLP_Second, CNNMnist, CNNCifar
...
if __name__ == '__main__':
    ...
    if args.model == 'cnn' and args.dataset == 'cifar':
        ...
        #first_model = MLP_First(dim_in=len_in, dim_hidden=200).to(args.device)   .......................delete MLP First function
        #second_model = MLP_Second(dim_hidden=200, dim_out=args.num_classes).to(args.device)

    else:
        exit('Error: unrecognized model')
    print(net_model)
    args.execlayer_num = net_model.execlayer_num
    net_model.train()
